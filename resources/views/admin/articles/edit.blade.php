...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6">Modifier l'article : {{ $article->titre }}</h1>
    ...
    <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-4">
            ...
            @if($article->image)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $article->image) }}" alt="{{ $article->titre }}" class="h-32 w-auto">
                    <label class="flex items-center mt-2">
                        <input type="checkbox" name="remove_image" value="1" class="form-checkbox h-4 w-4 text-blue-600">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.articles.show', $article) }}" class="text-gray-600 hover:text-gray-800">
                Annuler
            </a>
        </div>
    </form>
